...
${BUILD}/ConstraintProblem.o: ${SOURCE}/Constraint.h ${SOURCE}/Buffer.h ${BUILD}/LinearProblem.o ${SOURCE}/ConstraintProblem.h ${SOURCE}/ConstraintProblem.cpp ${BUILD}/log.o
...
${BUILD}/ConstraintGenerator.o : ${SOURCE}/ConstraintGenerator.cpp ${SOURCE}/ConstraintGenerator.h ${BUILD}/ConstraintProblem.o ${BUILD}/log.o ${SOURCE}/VarLiteral.h ${SOURCE}/Helpers.h ${SOURCE}/Buffer.h
